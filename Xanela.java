...
public class Xanela extends Frame {
	...
	public TextArea taMatriz, taLog;
	...
	public Xanela()
	 {
		...
		oCBMI.addItemListener(escoita);
	  	oMenu.add(oCBMI);
		oMB.add (oMenu);
		oMI = new MenuItem ("Limpiar Log", new MenuShortcut('C'));
		...
		Label l = new Label();
		l.setText("       Tipo         Nombre             ID               G            P        Parcial      Total      ");
		...
		taMatriz.setText(xogo.toStringMatriz());
